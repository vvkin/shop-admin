...
(
	...
	'Кожен хто будує будинок, хоче щоб він був не 
тільки надійним, але красивим і неповторним. 
Здійснити всі свої найсміливіші бажання і політ 
фантазії як у рядового забудовника, так і у досвідчених 
архітекторів, дизайнерів і будівельників допоможе дана
цегла. В асортименті компанії велика різноманітність 
розмірів форм і фактур: вузький, кутовий, модульний, широкий, зі 
скошеним кутом.'
),
(
	8, 7, 'Плитка тротуарна TT1 1000х500х60мм', 
	'BIB61W-JM', 145.0, 0.05, 587, 4.9, 
	'Плитка тротуарна ТТ-1 використовується для облагороджування 
територій біля будинку, гаража, доріжок в саду та інших об''єктів. 
За своєю формою дуже унікальна, зрізана по краях та має товщину 6 
сантиметрів (6 см). Дана плитка є хорошою заміною аналогам розміру 
500х1000х45 мм. Підвищена товщина сприяє тому, що матеріал впевнено 
утримує значі навантаження.'
),
(
	8, 7, 'Тротуарна плитка "Цегла" вібропресована', 
	'UNO87N-LK', 212.43, 0.0, 233, 4.5, 
	'Наша тротуарна плитка це якісний ущільнений бетон, а 
отже міцна і морозостійка плитка, зносостійкий лицьовий 
шар якої на основі кварцового піску.'
),
(
	18, 9, 'Лінолеум на тканинній основі "Алекс"', 
	'LBH12I-JC', 65.0, 0.0, 58, 4.65, 
	'Лінолеум від провідного виробника України на тканнний основі має приємну 
текстуру та високу теплоутримувальну здатність, випускається в кількох кольорах, 
тому підійде для будь-якого інтер''єру кімнати'
),
(
	18, 11, 'Лінолеум IDEAL Ultra CRACKED2', 
	'ORO09G-AL', 300.0, 0.0, 13, 4.9, 
	'Це найтовстіший лінолеум, теплозберігальна здатність якого просто вражає. 
Товщина 4.3мм дає можливість укладати лінолеум на цементну стяжку, тоді 
як велика товщина дозволяє зберігає в 3 рази більше тепла, а також надає шумоізоляцію, 
яка є найкращою серед аналогів.Также товщина допомагає виправити дрібні нерівності підлоги, 
це можуть бути дрібні нерівності стяжки, нерівний старий паркет, дошки, плитка і т.д. Утеплювач 
виготовлений на поліестровій основі, що робить його стійким до вологи.'
),
(
	9, 10, 'Бітумна черепиця Бардолін TOP Сота коричнева 3 кв.м', 
	'ARK54O-PI', 333.0, 0.0, 120, 5.0, 
	'Бітумна черепиця від вітчизняного виробника вирізняється серед 
аналогів вдалим поєднанням зовнішнього вигляду та надійності. Є
чудовим вибором для виконання покрівельних робіт для приватних будинків,
адже є простою у застосуванні та володіє невеликою вагою, що значно спрощує
робочий процес.'
),
(
	9, 10, 'Металочерепиця матова PSM 1180x1200 мм RAL 7024 графітова', 
	'EAX19L-OH', 336.0, 0.0, 54, 4.2, 
	'Металочерепиця є довговічним і міцним покрівельним матеріалом, 
на який нанесено зображення класичної керамічної черепиці. Листи зроблені 
з оцинкованої сталі, відрізняються стійкістю до корозії та зовнішніх чинників. 
Металочерепиця має легку вагу і може укладатися на різні типи дахів, які мають 
кут нахилу не менш 10 градусів. Також підходить для монтажу поверх старого покрівельного 
